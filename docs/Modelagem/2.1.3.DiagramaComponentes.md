...
| [Gabriel Saraiva Canabrava]()    | Diagrama de Caso de Uso | Participei da criação dos componentes relacionados ao treino e à autenticação, contribuindo para definir suas funcionalidades e garantir que estivessem alinhados com os requisitos do sistema. | A criação dos componentes de treino e autenticação foi uma etapa essencial do projeto, mas também desafiadora. Durante o processo, percebi a importância de alinhar bem os requisitos com a lógica de implementação, principalmente para garantir uma experiência fluida e segura para o usuário.        | [Ata 08](../Projeto/IniciativasExtras/ata_08.md) e [AtA 09](../Projeto/IniciativasExtras/ata_09.md) |
...
**Gravações da produção do Diagrama de Componentes:**
...
| '1.1'  | 08/05/2025 | Adicionando introdução, metodologia, resultados, gravações da produção dos artefatos, rastreabilidade | [Lucas Gama De Araujo Bottino]() |         |
