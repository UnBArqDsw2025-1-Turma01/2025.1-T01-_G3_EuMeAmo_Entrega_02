...
| Fillipe Souto | Diagrama de Classes | Contribui com ideais para a modelagem do diagrama | Um ponto que foi essencial para finalizar o diagrama de classe foi nos reunirmos para fazermos juntos e gerar novas ideias. | [Ata 07](../Projeto/IniciativasExtras/ata_07.md) |
