...
|------------|----------|------------|------------|---------|
| [Carlos Henrique](https://github.com/carlinn1) | Diagrama de Caso de Uso | Participou da produção do diagrama 1. | A análise de um diagrama de caso de uso facilita a identificação das funcionalidades oferecidas pelo sistema, bem como dos usuários que interagem com cada uma delas. Observando o diagrama elaborado pelo grupo, é possível notar como esse recurso visual é importante para compreender, de forma clara e organizada, o papel de cada tipo de usuário — como o Aluno e o Especialista — dentro do funcionamento do sistema. | [Ata 10](../Projeto/IniciativasExtras/ata_10.md) |
| [Pablo Serra](https://github.com/Pabloserrapxx) | Diagrama de Caso de Uso | Participou da produção do diagrama 1. | Aprender com um diagrama de caso de uso ajuda a visualizar de forma clara quais funcionalidades o sistema oferece e quem interage com elas. Com base no artefato produzido pelo grupo, percebo que esse tipo de diagrama é fundamental para oferecer uma visualização clara das principais funcionalidades do sistema e de como os diferentes usuários (Aluno e Especialista) interagem com ele. | [Ata 10](../Projeto/IniciativasExtras/ata_10.md)|
| [Rodrigo Fonseca](https://github.com/rodfon3301) | Diagrama de Caso de Uso | Participou da produção do diagrama 1. | Estudar um diagrama de caso de uso contribui para compreender de forma mais objetiva quais são as funcionalidades disponíveis no sistema e quem são os responsáveis por utilizá-las. A partir do artefato desenvolvido pelo grupo, percebo que esse tipo de representação é essencial para ilustrar de maneira clara as principais ações do sistema e como os diferentes perfis de usuários, como Aluno e Especialista, se relacionam com essas funcionalidades. | [Ata 10](../Projeto/IniciativasExtras/ata_10.md) |
|  [Gabriel Saraiva](https://github.com/gabrielsarcan) | Diagrama de Caso de Uso | Participou da produção do diagrama 2. | Foi muito importante elaborar o diagrama de caso de uso, pois ele ajudou a entender com mais clareza quais atores interagem com o sistema e quais funcionalidades cada um pode acessar. Essa definição foi essencial para planejar corretamente os níveis de acesso e organizar o desenvolvimento de acordo com os papéis de cada usuário.  | [Ata 5](../Projeto/IniciativasExtras/ata_05.md) |
...
| [Lucas Bottino](https://github.com/bottinolucas)    | Diagrama de Caso de Uso | Participou da produção do diagrama 3. | Após a análise dos outros diagramas de caso de uso desenvolvidos pelos outros integrantes do grupo, decidimos fazer um diagrama mais completo com todos aspectos definidos no escopo mínimo focando no usuário principal. | [Ata 08](../Projeto/IniciativasExtras/ata_08.md) e [Ata 09](../Projeto/IniciativasExtras/ata_09.md)  |
